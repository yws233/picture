...
<%--选课提交信息--%>
<h1 style="text-align: center;color: #4B63BB">中农导师交换系统(<span style="color: red">极简测用,敬请谅解</span>)&nbsp;&nbsp;<a style="font-size: 16px" href="${pageContext.request.contextPath}/sys/user/backmain.html"><< 返回首页</a></h1>
<p style="color: #4B63BB;font-size: 14px">使用说明<span style="color: red">(请使用谷歌浏览器)</span>：1.提交和查看区域，填写后点击提交，即可完成导师选择填写，点击查看按钮可以查看目前的选导师情况及学生信息、总的填写人数等，本系统的提交昵称一律采取自由匿名的方式，所以请提交的同学牢记自身的昵称和编码等信息，也可点击查看显示。2.修改区域，请同学们查看自己的编码号和昵称等信息外，<span style="color: red">（私下交换后）</span>导师可选择修改,填写完相关信息即可点击修改提交，随后可点击查看按钮，查看修改情况。3.本系统为临时服务大家，时间仓促，难免出现安全漏洞，请大家牢记自己的编码和昵称等信息，不要乱修改他人信息，thank you !
    有任何问题可联系管理员yws, 邮箱:2602970992@qq.com
</p>
<%--抽取导师--%>
<div class="roll-area">
    <h2 class="roll-title">导师抽取</h2>
    <p class="show">Name Show</p>
    <button class="start" onclick="chou()">开始</button>
    <button class="end" onclick="clearTimeout(mytime)">结束</button>
</div>

<div style="display:inline-block;border: 1px solid #8FB5E8;width: 400px;height: auto;text-align: center;margin-left: 60px">
    <%--提交表单--%>
...
<div style="display:inline-block;border: 1px solid #8FB5E8;width: 400px;height: auto;text-align: center;margin: 0 auto">
    <%--提交表单--%>
    <h2 style="text-align: center;color: #4B63BB">修改导师信息</h2>
     <%--修改表单--%>
...
<div class="bottom" style="text-align: center">
    <p style="color: black">Copyright © 2017-2018&nbsp;&nbsp;All Rights Reserved<a target="_blank" href="https://github.com/yws233/kuaib" style="color: #4B63BB">&nbsp;&nbsp;yws&nbsp;快编系统</a></p>
</div>

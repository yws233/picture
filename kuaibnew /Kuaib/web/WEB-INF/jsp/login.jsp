...
<div class="navbar-header">
    <div class="logo">
        <h1 id="logo-png">
            <a href="https://github.com/yws233/kuaib">Kuaib.COM</a>
        </h1>
    </div>
</div>
    ...
    <ul class="grid cs-style-4">
        <li>
            <figure>
                ...
                <figcaption>
                    <a href="https://github.com/yws233/kuaib">便捷查询</a>
                </figcaption>
            </figure>
        </li>
        <li>
            <figure>
                ...
                <figcaption>
                    <a href="https://github.com/yws233/kuaib">更加实用</a>
                </figcaption>
            </figure>
        </li>
        <li>
            <figure>
                ...
                <figcaption>
                    <a href="https://github.com/yws233/kuaib">赏心悦目</a>
                </figcaption>
            </figure>
        </li>
        <li>
            <figure>
                ...
                <figcaption>
                    <a href="https://github.com/yws233/kuaib">单一窗口</a>
                </figcaption>
            </figure>
        </li>
        <li>
            <figure>
                ...
                <figcaption>
                    <a href="https://github.com/yws233/kuaib">众多功能</a>
                </figcaption>
            </figure>
        </li>
        <li>
            <figure>
                ...
                <figcaption>
                    <a href="https://github.com/yws233/kuaib">直达所思</a>
                </figcaption>
            </figure>
        </li>
    </ul>

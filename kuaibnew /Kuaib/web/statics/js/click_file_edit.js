jQuery(document).ready(function () {
    jQuery(".wordclick").dblclick(function () {
        ...
        if (text) {
            jQuery(this).html("<textarea id='clear-txt' style='border:none; border-top: 1px solid #E8F3FE; background: white;width:395px;height:325px; outline: none;' name=" + id + " >" + text + "</textarea>");

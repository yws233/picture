...
<div class="container">
    <div class="navbar-header">
        <div class="logo">
            <h1>
                <a id="logo-1" href="https://github.com/yws233/kuaib">Kuaib.COM</a>
    ...
    <div class="context">
        <div class="left" id="left" style="height: 480px;width: 395px;word-break: break-all"><%--contentEditable="true" 设置div为可编辑--%>
            ...
            <span style="color: #4B63BB;font-size: 14px;font-weight: bold">${upath}</span><a name="${filename}" href="${pageContext.request.contextPath}/sys/user/download.html?filename=${filename}">${filename}&nbsp;&nbsp;<span style="color: #4B63BB;font-size: 14px;font-weight: bold">${filecount}</span></a>
            <br/>
        ...
        <div class="middle" style="background: white;margin-top: 10px;height: 480px;box-shadow:  1px 2px 2px #C1C1C1;">
            <textarea id="txt-more" <%--class="xheditor"--%> class="xheditor-mfull" rows="17" cols="90" style="margin: 0px;height: 275px;width: 100%;box-shadow: none" name="txt-more">
                <span style="font-size: 18px">点击右上方全屏编辑按钮，可实现本区域全屏编辑，如要实现字数实时统计,可在下方编辑区域内编辑，或者将文字粘贴至下方实时计数编辑区域内...</span>
            </textarea>
            <textarea id="status" name="status" onkeydown='countChar("status","counter");' onkeyup='countChar("status","counter");'>实时计数编辑区域,右下角可以拖动调整大小..</textarea>
        ...
        <div class="btn-ctrl">
            ...
            <button id="btn-2" type="button"><a id="exhref" href="${pageContext.request.contextPath}/sys/user/exchange.html">导师系统</a></button>
       ...
       /* 返回访问值 */
        ...
        <div class="bottom">
            <p>Copyright © 2017-2018&nbsp;&nbsp;All Rights Reserved<a target="_blank" href="https://github.com/yws233/kuaib">&nbsp;&nbsp;yws&nbsp;快编系统</a>&nbsp;|&nbsp;<span style="color: #666666">访问量：<%= hitsCount%></span></p>
        </div>
    </div>
</div>
